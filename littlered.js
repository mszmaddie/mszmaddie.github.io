...
function auto() {
    if ( autos == "off" ) {
        autos = "on";
        document.getElementById("abutton").style.background = "#3EF095";
...
function generate() {
    ...
    (function() {
        ...
        document.getElementById("codebox").innerHTML = "&lt;script src&equals;&quot;https://mszmaddie.github.io/littleredplayer.js&quot;&gt;&lt;&sol;script&gt;&lt;div id&equals;&quot;xlittleplayer&quot;&gt;&lt;span id&equals;&quot;xlittleplayerinfo&quot; style&equals;&quot;display:none;&quot;&gt;" + oneinfonew + "&lt;&sol;span&gt;&lt;span id&equals;&quot;xlittleplayernames&quot; style&equals;&quot;display:none;&quot;&gt;" + twoinfonew + "&lt;&sol;span&gt;&lt;&sol;div&gt;";

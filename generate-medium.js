...
function generate() {
    ...
    document.getElementById("desc").innerHTML = "First code: Paste where you want the player to be. <br>Second code: Paste just before /body (located near the end of your blog or website’s HTML)."
